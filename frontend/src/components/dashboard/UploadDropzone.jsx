    ...
    <div>
      <motion.div
        ...
        animate={
          status === 'success'
            ...
            ? { borderColor: '#C65A5A' }
            : dragOver
            ? { borderColor: '#8B5E3C', backgroundColor: '#8B5E3C/5' }
            : { borderColor: '#E8DDD0' }
        }
        ...
        className={cn(
          ...
          isDisabled ? 'opacity-50 cursor-not-allowed' : 'hover:bg-[#F8F5F0]',
      ...
      >
        ...
        {status === 'success' ? (
          ...
          >
            <div className="w-12 h-12 rounded-full bg-[#4F7D5C]/10 flex items-center justify-center">
              <CheckCircle className="w-6 h-6 text-[#4F7D5C]" />
            </div>
          ...
          <div className="flex flex-col items-center gap-3">
            <FileText className="w-8 h-8 text-[#8B5E3C] animate-pulse" />
          ...
          <motion.div
            ...
            className="flex flex-col items-center gap-2"
          >
            <div className="w-12 h-12 rounded-full bg-[#C65A5A]/10 flex items-center justify-center">
              <AlertCircle className="w-6 h-6 text-[#C65A5A]" />
            </div>
            <p className="text-sm text-[#C65A5A]">{error}</p>
            <button
              type="button"
              onClick={(e) => { e.stopPropagation(); reset(); }}
              className="text-xs text-[#6B665F] hover:text-[#8B5E3C] underline transition-colors"
            >
              Try again
            </button>
          </motion.div>
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="w-12 h-12 rounded-full bg-[#E8DDD0]/50 flex items-center justify-center">
              <Upload className="w-6 h-6 text-[#6B665F]" />
            </div>
